...
**Date:** 2026-08-16
**Symptôme:** 
Le README.md sur GitHub affiche un lien cassé "GEF Certified: Silver" qui pointe vers gef-certified-badge.svg inexistant.

**Cause Racine:** 
Le fichier gef-certified-badge.svg a été ajouté à .gitignore pour éviter de commiter les badges générés localement, mais le badge n'a jamais été commité dans le dépôt. Le badge a été ajouté au README.md par erreur lors des tests du Certification System.

**Résolution:** 
- Suppression de la ligne du badge dans README.md
- Les badges doivent être générés uniquement localement par les utilisateurs via `npx create-gef certify generate`
- Le badge ne doit pas être dans le README.md du framework lui-même, mais uniquement dans les projets générés

**Leçon:** 
Les artefacts générés localement (badges, rapports) ne doivent jamais être référencés dans les fichiers du framework lui-même, car ils n'existent pas dans le dépôt public.
...
## [Bug] Audit Phase 1 - Corrections Critiques du G�n�rateur
**Date:** 2026-08-11
**Sympt�me:** 
Plusieurs bugs bloquants identifi�s lors de l'audit de la version 1.15.0 :
1. Le fichier \.cursorrules\ g�n�r� contenait les variables brutes \{{MAX_LINES}}\ sans substitution.
2. Le fichier \locales/en/.cursorrules\ �tait corrompu (en fran�ais).
3. Des fichiers d�pr�ci�s (\prompts/*.md\) �taient toujours copi�s.
4. Commentaires obsol�tes dans \setup-ci.js\.

**Cause Racine:** 
1. \setupAiRules\ ne faisait pas appel � la fonction de templating avant d'�crire.
2. Une erreur manuelle lors du d�veloppement Agentic SDD avait �cras� le fichier anglais avec la version fran�aise.
3. Le code de \setup-gef.js\ n'avait pas �t� nettoy� apr�s le passage aux r�gles contextuelles.

**R�solution:** 
- Injection de \pplyTemplating\ dans \setup-ai-rules.js\.
- Restauration de l'ancienne version anglaise de \.cursorrules\ et traduction de la section SDD ajout�e r�cemment.
- Suppression de la copie des prompts dans \setup-gef.js\.
- Mise � jour du commentaire dans \setup-ci.js\.

**Le�on:** 
L'audit continu (verify-self) est indispensable pour garantir que la documentation et le code racontent la m�me histoire. Il faut automatiser la d�tection des placeholders non r�solus.
