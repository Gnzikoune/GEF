// features/scaffold-ci-blocks.js — Blocs de construction pour le pipeline CI/CD

// ─────────────────────────────────────────────
// BLOC : Trigger / On
// ─────────────────────────────────────────────
export function buildTriggers(gitWorkflow) {
...
// ─────────────────────────────────────────────
export function buildServiceBlock(database) {
...
// BLOC : Setup runtime
// ─────────────────────────────────────────────
export function buildRuntimeBlock(isNode, isPython) {
  if (isNode) {
...
// BLOC : Lint
// ─────────────────────────────────────────────
export function buildLintBlock(isNode, isPython, linter) {
  if (isNode) {
...
// ─────────────────────────────────────────────
export function buildAuditBlock(isNode, isPython) {
  if (isNode) {
...
// BLOC : Tests + coverage
// ─────────────────────────────────────────────
export function buildTestBlock(isNode, isPython, database) {
...
// ─────────────────────────────────────────────
export function buildSecurityScanBlock() {
...
// ─────────────────────────────────────────────
export function buildDockerImageBlock(projectName, containerRegistry, cloud) {
...
// ─────────────────────────────────────────────
export function buildStagingBlock(isMissionCritical, hasDockerImage) {
...
// ─────────────────────────────────────────────
export function buildDeployBlock(cloud, isMissionCritical, hasDockerImage) {
