...
GEF is the **first open-source technical implementation of the AI SDD** (*AI Spec-Driven Development*) methodology.
This methodology clearly separates roles between humans and AI in a modern development loop:
- The human **Defines** the specifications and **Verifies** the results (quality, security).
- The AI **Analyzes/Designs** and **Implements/Tests** (constrained execution).

To ensure this model works without drift, GEF is built on a single principle: **engineering rules should not be re-read — they must be mechanically enforced.**
